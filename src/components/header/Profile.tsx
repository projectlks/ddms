...
export default function Profile() {
    ...
    return (
        ...
        >
            ...
            >
                <span
                    className="mr-3 h-11 w-11 overflow-hidden relative rounded-full"
                >
                    <span
                        className=" z-1 w-full h-full rounded-full bg-blue-500 text-gray-100 text-2xl flex justify-center items-center"
                    >
                        {/* Replace with Start letter of Use Name  */}
                        <p>M</p>
                    </span>
                </span>
                <span
                    className="mr-1 sm:inline-block hidden  font-medium text-sm"
                >
                    Admin
                </span>
                <svg
                    className="stroke-gray-500 sm:inline-block hidden"
                    width="18"
                    height="20"
                    viewBox="0 0 18 20"
                    fill="none"
            ...
            {showProfile && <div
                ...
                className="absolute right-0 mt-4 w-[260px] rounded-2xl border border-gray-200 bg-white p-3 shadow-lg z-50"
            >
                <div>
